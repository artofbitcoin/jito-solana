...
Ce dépôt est accompagné d un parcours pédagogique en français dans [docs/fr/](./docs/fr/), consacré au client Jito Solana, à l exécution des blocs et aux optimisations liées aux validateurs.
